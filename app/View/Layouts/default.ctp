...
oc deploy cakephp-mysql-example --latest
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <h3>Command Line</h3>
                <p>With the <a href="http://Test-001/latest/cli_reference/overview.html">OpenShift command line interface</a> (CLI), you can create applications and manage projects from a terminal.</p>
